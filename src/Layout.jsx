            ...
            <div className="flex items-center gap-2">
              ...
              <>
                  <Link to={createPageUrl("Dashboard")}>
                    <Button size="sm" variant="outline" className="bg-[#393a3c] text-white px-3 text-xs font-medium rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border shadow-sm hover:text-accent-foreground h-8 border-white/30 hover:bg-white/10">Dashboard</Button>
                  </Link>
