            ...
            <div key={activity.id || i} className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm leading-snug">
                  ...
                  {activity.content_title && <span className="text-foreground"> « {activity.content_title} »</span>}
                  {activity.details && <span className="text-muted-foreground"> · {activity.details}</span>}
                </p>
                <div className="flex items-center gap-2 mt-0.5">
                  {activity.kp_earned > 0 && (
                    <span className="text-xs text-accent font-semibold">+{activity.kp_earned} KP</span>
                  )}
